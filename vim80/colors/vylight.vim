...
" Syntax highlighting
hi Comment       guifg =#7F7F7F gui=none
...
hi Conditional   guifg=#2641A3  gui=bold
hi Delimiter     guifg=#1a1a1a  gui=none
"hi PreProc       guifg=#006633  gui=none
"hi Special       guifg=#006633  gui=none
hi PreProc       guifg=#1D7B1F  gui=italic
hi Special       guifg=#660033  gui=none
hi Keyword       guifg=#007050  gui=none

hi def cCustomFunc  gui=bold guifg=black
hi def cCustomClass gui=reverse guifg=red
